...
1. nike.py 
- B ased on linear regression analysis. Stocks are selected if the slope of their price trend has been negative in the past seven days but is positive in the most recent observation. The selected stocks are then allocated equal funds.
